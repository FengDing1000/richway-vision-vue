                            ...
                            [
                                {
                                    ...
                                    value: `1`,
                                    type: `radio`,
                                    options: [{label: `全部`, value: `1`}, {label: `超警戒测站`, value: `2`}, {
                                        label: `超保证测站`,
                                        value: `3`
                                    }]
                                }
                        ...
                        fieldList: [
                            ...
                            },
                            {
                                ...
                                render: {
                                    type: `html`,
                                    data: (row = {}) => {
                                        if (row.overWrq === `` || row.overWrq === null || row.overWrq === undefined) {
                                            return ``;
                                        }
                                        return Number(row.overWrq).toFixed(2);
                                    }
                                }
                            },
                            {
                                ...
                                render: {
                                    type: `html`,
                                    data: (row = {}) => {
                                        if (row.overGrq === `` || row.overGrq === null || row.overGrq === undefined) {
                                            return ``;
                                        }
                                        return Number(row.overGrq).toFixed(2);
                                    }
                                }
                            },
                            {
