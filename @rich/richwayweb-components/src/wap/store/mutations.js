...
export default {
    ...
    // WAP端全局的提示弹窗
    [_mt.SET_TOAST](state, opt = {}) {
        state.toast = Object.assign({}, _setting.toast, opt);
    },

    // WAP端全局的信息弹窗
    [_mt.SET_MESSAGE_BOX](state, opt = {}) {
        state.messageBox = Object.assign({}, _setting.messageBox, opt);
    },
