<template>
	<section
		class="richway-container richway-layout-wap-base richway-clear">
		<!-- 头部 -->
		...
		<!-- 中间区域 -->
		<LayoutMain v-if="layoutInfo.main.display === `show`">
...
const LayoutHeader = r => require.ensure([], () => r(require(`./header`)), `components/layout/base`);
const LayoutMain = r => require.ensure([], () => r(require(`./main`)), `components/layout/base`);
const LayoutFooter = r => require.ensure([], () => r(require(`./footer`)), `components/layout/base`);
