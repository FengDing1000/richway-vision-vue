...
const info = {
    ...
    // vue-route的配置文件路径
    routes_pc_path: `src/pc/router/routes.js`,
    routes_wap_path: `src/wap/router/routes.js`,
    // vux模块的配置文件路径
    modules_pc_path: `src/pc/store/modules.js`,
    modules_wap_path: `src/wap/store/modules.js`,
