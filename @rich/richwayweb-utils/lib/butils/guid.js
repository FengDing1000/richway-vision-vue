...
function GUID() {
    ...
    if (typeof this.newGUID !== `function`) {
         ...
         * 返回值：返回GUID日期格式的字条串
         */
        GUID.prototype.getGUIDTime = () => this.addZero(this.date.getHours()) + this.addZero(this.date.getMinutes()) + this.addZero(this.date.getSeconds()) + this.addZero(parseInt(this.date.getMilliseconds() / 10, 10));
...
module.exports = () => new GUID().newGUID();
